...
void menu() {
    ...
    cout << "What would you like to add: 1. main course 2. dessert 3. apetizers 4. drinks: ";
    cin >> nr;
    ...
    while (getline(file, line)) {
        ...
        if (getline(ss, tableNumStr, ',') &&
            ...
            try {
                ...
                if (tableNum == table) {
                    tableFound = true;
                    cout << "Table Number: " << tableNum << ", Item: " << itemName << ", Quantity: " << itemQuantity << ", Total Price: " << itemTotalPrice << endl;
                }
            }
            ...
            cerr << "Error: Malformed line in file. Line skipped: " << line << endl;
        }
    }
...
void login(const string& staffFile) {
    ...
    if (checkUserExistence(username, password)) {
        ...
        do {
            ...
            case 4:
                break;//for now.. we will meet again
            case 5:
                cout << "Exiting..." << endl;
                break;
            default:
